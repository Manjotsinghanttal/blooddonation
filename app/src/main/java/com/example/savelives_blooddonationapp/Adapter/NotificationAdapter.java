package com.example.savelives_blooddonationapp.Adapter;
...
import com.example.savelives_blooddonationapp.R;
import com.example.savelives_blooddonationapp.model.Notification;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.notication_items,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            notification_date =itemView.findViewById(R.id.notification_data);
