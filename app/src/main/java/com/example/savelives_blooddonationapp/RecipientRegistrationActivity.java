...
public class RecipientRegistrationActivity extends AppCompatActivity {
    ...
    private EditText registerFullName,registerIdName,registerPhoneNumber,registerEmail,registerPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerIdName = findViewById(R.id.registerIdName);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String idNumber = registerIdName.getText().toString().trim();
                ...
                if(TextUtils.isEmpty(idNumber)){
                    registerIdName.setError("ID is required");
                    return;
                }
                ...
                if(bloodGroup.equals("Select Blood Group")){
                    Toast.makeText(RecipientRegistrationActivity.this, "Please Select Blood Group", Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                                ...
                                if(resultUri != null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RecipientRegistrationActivity.this, "Image Upload is failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(RecipientRegistrationActivity.this, "Image url added to database sucessfully", Toast.LENGTH_SHORT).show();
                                                                }
                                                                else{
                                                                    Toast.makeText(RecipientRegistrationActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Intent intent = new Intent(RecipientRegistrationActivity.this,HomeActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
                                }
